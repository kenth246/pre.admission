...
export default function AdminDashboard() {
  ...
  // Mock Data (IDs updated to match Applications.jsx format)
  const [applicants, setApplicants] = useState([
    { id: "2026-0001", name: "Juan Dela Cruz", type: "Freshmen", location: "Pulilan", date: "12/15/25", status: "Pending Interview", email: "juan.dc@email.com" },
    { id: "2026-0002", name: "Maria Santos", type: "Transferees", location: "Baliwag", date: "12/16/25", status: "Admitted", email: "maria.s@email.com" },
    { id: "2026-0003", name: "Jose Rizal", type: "Freshmen", location: "Malolos", date: "12/17/25", status: "Pending Interview", email: "jose.r@email.com" },
    { id: "2026-0004", name: "Andres Bonifacio", type: "Freshmen", location: "Pulilan", date: "12/18/25", status: "Pending BCET", email: "andres.b@email.com" },
    { id: "2026-0005", name: "Gabriela Silang", type: "Transferees", location: "Plaridel", date: "12/19/25", status: "Pending Interview", email: "gab.s@email.com" },
    { id: "2026-0006", name: "Emilio Aguinaldo", type: "Freshmen", location: "Baliwag", date: "12/20/25", status: "Pending BCET", email: "emilio.a@email.com" },
    { id: "2026-0007", name: "Apolinario Mabini", type: "Freshmen", location: "Pulilan", date: "12/21/25", status: "Admitted", email: "pol.m@email.com" },
  ]);
  ...
  useEffect(() => {
    ...
    const transfereesCount = applicants.filter((a) => a.type === "Transferees").length;
  ...
  const recentApplicants = applicants.filter(a => a.status === "Pending Interview");
                  ...
                  recentApplicants.map((app) => (
                    <tr key={app.id} className="hover:bg-gray-50 transition">
                      ...
                      <td className="p-4 text-center">
                        <button 
                          onClick={() => navigate('/admin/applications', { state: { applicantId: app.id } })}
